// src/components/CaixaLojaDetalhado.tsx
'use client'
...
export default function CaixaLojaDetalhado({ titulo }: CaixaLojaDetalhadoProps) {
  const {
    caixaRealLoja,
    caixaPrevistoGeral,
    entradasHoje,
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-1 space-y-1" style={{ minWidth: 0 }}>
      <h2 className="font-semibold text-gray-800" style={{ fontSize: '12px' }}>{titulo || 'Caixa Loja'}</h2>
